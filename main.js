...
function displayCustomers () {
    for (let customer of customers) {
      ...
      <h4>${customers.name.first + " " + customers.name.last}</h4>
      <p>${customers.email}</p>
      <p>${customers.location.street.number + " " + customers.location.street.name + " " + customers.location.city + " " + customers.location.state + " " + customers.location.postcode}</p>
      <p>${customers.dob.date}</p>
      <p>${customers.registered.date}</p>
  </div>`
    }
  }
...
// customersDiv.innerHTML += `<p>${customers[1].location.street.number + " " + customers[1].location.street.name + " " + customers[1].location.city + " " + customers[1].location.state + " " + customers[1].location.postcode}</p>`
...
// customersDiv.innerHTML += `<p>${customers[2].location.street.number + " " + customers[2].location.street.name + " " + customers[2].location.city + " " + customers[2].location.state + " " + customers[2].location.postcode}</p>`
...
// customersDiv.innerHTML += `<p>${customers[3].location.street.number + " " + customers[3].location.street.name + " " + customers[3].location.city + " " + customers[3].location.state + " " + customers[3].location.postcode}</p>`
...
// customersDiv.innerHTML += `<p>${customers[4].location.street.number + " " + customers[4].location.street.name + " " + customers[4].location.city + " " + customers[4].location.state + " " + customers[4].location.postcode}</p>`
...
// customersDiv.innerHTML += `<p>${customers[6].location.street.number + " " + customers[6].location.street.name + " " + customers[6].location.city + " " + customers[6].location.state + " " + customers[6].location.postcode}</p>`
...
// customersDiv.innerHTML += `<p>${customers[7].location.street.number + " " + customers[7].location.street.name + " " + customers[7].location.city + " " + customers[7].location.state + " " + customers[7].location.postcode}</p>`
...
// customersDiv.innerHTML += `<p>${customers[8].location.street.number + " " + customers[8].location.street.name + " " + customers[8].location.city + " " + customers[8].location.state + " " + customers[8].location.postcode}</p>`
...
// customersDiv.innerHTML += `<p>${customers[9].location.street.number + " " + customers[9].location.street.name + " " + customers[9].location.city + " " + customers[9].location.state + " " + customers[9].location.postcode}</p>`
...
// customersDiv.innerHTML += `<p>${customers[10].location.street.number + " " + customers[10].location.street.name + " " + customers[10].location.city + " " + customers[10].location.state + " " + customers[10].location.postcode}</p>`
...
// customersDiv.innerHTML += `<p>${customers[11].location.street.number + " " + customers[11].location.street.name + " " + customers[11].location.city + " " + customers[11].location.state + " " + customers[11].location.postcode}</p>`
